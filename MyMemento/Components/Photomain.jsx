...
export const Photomain = () => {
  ...
  const showeditlist = (id) => {
    let list = document.querySelectorAll('.showeditlist')
    list[id].classList.toggle('showlistnow')
}
          ...
          </div>
          {
            imagesArray.length != 0 ? imagesArray.map((url,index) => {
              return <div className='photo_box' key={url}>
                ...
                <img src={url} alt={url} />
                <div className="showeditlist">
                  <div className="view listitem">
                  ...
                  <div className="favourite listitem">
